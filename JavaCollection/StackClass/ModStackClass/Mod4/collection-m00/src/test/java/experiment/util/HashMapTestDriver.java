...
public class HashMapTestDriver {
    ...
    protected static final Logger logger = Logger.getLogger(HashMapTestDriver.class.getName());
    ...
    static {
    	try {
			...
			writer = new FileWriter(String.format("HashMapTestDriverData_seed%s_limit%s.csv", seed, limit));
		} catch (IOException e) {
    ...
    protected experiment.util.HashMap getClassUnderTest() {
        if(classUnderTest == null) {
            classUnderTest = new experiment.util.HashMap();
        }
