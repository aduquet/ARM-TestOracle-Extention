...
javac -d .\target\test-classes -classpath .;C:\Users\duquet\Documents\Installers\junit-4.13.jar;target\classes\;target\test-classes\ src\test\java\%testclasspath%\test\*_%2Test_%3_%4_*.java
